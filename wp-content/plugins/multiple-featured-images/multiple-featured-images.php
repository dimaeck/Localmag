...
if( !class_exists( 'kdMultipleFeaturedImages' ) ) {
    ...
    class kdMultipleFeaturedImages {
         ...
         * @return string
         */
        public static function get_the_featured_image( $image_id, $post_type, $size = 'full', $post_id = NULL, $attr = NULL ) {
            $id = self::get_featured_image_id( $image_id, $post_type, $post_id);
         ...
         * @return void
         */
        public static function the_featured_image( $image_id, $post_type, $size = 'full', $post_id = NULL, $attr ) {
            echo self::get_the_featured_image( $image_id, $post_type, $size, $post_id, $attr );
        }
    }
}
...
function kd_mfi_the_featured_image( $image_id, $post_type, $size = 'full', $post_id = NULL, $attr ) {
    return kdMultipleFeaturedImages::the_featured_image( $image_id, $post_type, $size, $post_id, $attr );
}
